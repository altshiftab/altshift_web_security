...
func TestAnalyze(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "case-insensitive same-origin", input: "SAME-ORIGIN", wantIDs: nil},
		{name: "unsafe-none", input: "unsafe-none", wantIDs: []string{rule_id.CrossOriginOpenerPolicyUnsafeNone}},
		{name: "same-origin-allow-popups", input: "same-origin-allow-popups", wantIDs: []string{rule_id.CrossOriginOpenerPolicyBadValue}},
		{name: "bogus", input: "bogus", wantIDs: []string{rule_id.CrossOriginOpenerPolicyBadValue}},
	}
