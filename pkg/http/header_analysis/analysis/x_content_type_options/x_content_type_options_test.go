...
func TestAnalyze(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "nosniff", input: "nosniff", wantIDs: nil},
		{name: "case-insensitive nosniff", input: "NoSniff", wantIDs: nil},
		{name: "bad value", input: "bogus", wantIDs: []string{rule_id.XContentTypeOptionsBadValue}},
	}
